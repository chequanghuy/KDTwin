...
class TotalLoss(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        return tversky_da_loss,tversky_ll_loss,focal_da_loss,focal_ll_loss
...
class TotalLossDA(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        return focal_da_loss.item(),tversky_da_loss.item(),loss
...
class TotalLossLL(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        return focal_ll_loss.item(),tversky_ll_loss.item(),loss
